    ...
    >
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/careers" className="text-white/80 hover:text-white text-sm">
                  Careers
                </Link>
              </li>
              <li>
                <Link href="/press" className="text-white/80 hover:text-white text-sm">
                  Press
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/our-story" className="text-white/80 hover:text-white text-sm">
                  Our Story
                </Link>
              </li>
              <li>
                <Link href="/team" className="text-white/80 hover:text-white text-sm">
                  Team
                </Link>
              </li>
              <li>
                <Link href="/partners" className="text-white/80 hover:text-white text-sm">
                  Partners
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/help" className="text-white/80 hover:text-white text-sm">
                  Help Center
                </Link>
              </li>
              <li>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="font-semibold text-lg mb-4">Email Newsletter</h3>
        ...
        <div className="border-t border-white/20 pt-8 text-center text-sm text-white/80">
          <p>&copy; {new Date().getFullYear()} BudgetStay. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
